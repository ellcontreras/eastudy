            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="container">
                        ...
                        <input type="text" class="input" v-model="question.data.title" placeholder="De que color es el caballo de napoleon?"/>
                        <br><br>
                        ...
                        <textarea v-model="question.data.content" class="textarea" placeholder="Habia un caballo bonito..."></textarea>
                    </div>
                    <hr>
    ...
    methods: {
        ...
        updateQuestion() {
            if (this.question.data.title && this.checkNullAnswers()) {
                const dbRef = firebase.database().ref(`/questions/${this.question.uid}`)
                ...
                dbRef.set({
                    ...
                    this.$toasted.show('Se ha actualizado la pregunta exitosamente!', {
                        theme: "bubble", 
                        position: "bottom-right", 
                        duration : 5000
                    })
        ...
        checkNullAnswers () {
            return this.question.data.answers[0].name && this.question.data.answers[1].name && 
                this.question.data.answers[2].name && this.question.data.category
        }
    }
}
</script>
